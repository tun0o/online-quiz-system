...
DO $$ BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'notification_type_enum') THEN
        CREATE TYPE notification_type_enum AS ENUM ('GRADING_COMPLETED', 'PAYMENT_SUCCESS', 'PAYMENT_FAILURE', 'SUBMISSION_APPROVED', 'SUBMISSION_REJECTED', 'RANKING_REWARD', 'WELCOME');
    END IF;
END $$;
