...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Update auth context với user data
            // Không cần gọi authLogin vì đã xử lý token và user data ở trên
    ...
    // OAuth2 login functions - ENABLED
    const handleGoogleLogin = () => {
        window.location.href = OAUTH2_URLS.GOOGLE;
    };

    const handleFacebookLogin = () => {
        window.location.href = OAUTH2_URLS.FACEBOOK;
    };
